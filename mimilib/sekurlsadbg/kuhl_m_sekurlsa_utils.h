...
typedef struct _KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ {
	struct _KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ *Flink;
	struct _KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ *Blink;
	PVOID unk0;
	ULONG unk1;
	PVOID unk2;
	ULONG unk3;
	...
	ULONG unk22;
	PVOID CredentialManager;
} KIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ, *PKIWI_MSV1_0_LIST_61_ANTI_MEMEDOGZ;
